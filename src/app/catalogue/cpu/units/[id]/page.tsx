...
export default async function Page({params}: { params: Promise<{ id: string }> }) {
    ...
    const kit = (await getComponent<CentralProcessor.UnitDto>(endpoint, id, [CatalogueTags.CENTRAL_PROCESSOR_UNITS])).data;
    ...
    return (
        <Form item={kit} action={action} params={unitParams}/>
    )
}