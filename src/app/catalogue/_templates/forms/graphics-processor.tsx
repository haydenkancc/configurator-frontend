...
import {
    ...
    GraphicsProcessorUnitConfigurationPowerSupplyConnectorListDataItem, PowerSupplyConnectorBase
...
export function GraphicsProcessorChipsetComboBox({...props } : ComboBoxProps<GraphicsProcessorChipset>) {
    return (
