...
import {PowerSupplyConnector, PowerSupplyConnectorDbo, PowerSupplyConnectorParams} from '@/server/models/components';
...
export function Form({ item, action, params } : PutFormProps<PowerSupplyConnector, PowerSupplyConnectorDbo, PowerSupplyConnectorParams>) {
