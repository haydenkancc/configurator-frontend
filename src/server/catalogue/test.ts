...
import {ApiClient, configuratorApiClient} from '@/server/catalogue/index';
import {PaginatedList, PCIeSlot, PCIeSlotRow} from '@/server/models';
...
export async function postComponentAction(endpoint: string, redirectBaseEndpoint: string, tags?: string[]) {
